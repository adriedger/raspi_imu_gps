...
def main(stdscr):
    ...
    stdscr.addstr(0, 0, "Andre's Avionics System", curses.A_BOLD)
    stdscr.addstr(1, 0, "Dests Reached: [{}]".format(" "*len(destinations)))
    stdscr.addstr(2, 0, "Going to: ")
    stdscr.addstr(3, 0, "Latitude: ")
    stdscr.addstr(4, 0, "Longitude: ")
    ...
    while(1):
        ...
        if(entry[0] == 0):
            ...
            stdscr.addstr(1, 16, "{}".format("#"*int(entry[2])), curses.color_pair(3))
            stdscr.addstr(2, 15, "{}".format(destinations[int(entry[2])]), curses.color_pair(4))
            stdscr.addstr(3, 15, "{}".format(entry[3]), curses.color_pair(3))
            stdscr.addstr(4, 15, "{}".format(entry[4]), curses.color_pair(3))
